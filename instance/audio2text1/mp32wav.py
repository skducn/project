...
MP32WAV('text2VoicePyttsx3.mp3','11111.wav')
# trans_mp3_to_wav("./text2VoicePyttsx3.mp3")
...
#
#     # MP3文件和WAV文件的地址
#     path1 = 'D:\\51\\python\\project\\instance\\audio2text1\\mp3'
#     path2 = "D:\\51\\python\\project\\instance\\audio2text1\\mp3"
