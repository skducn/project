...
# 环境变量
File_ExcelName = "/Users/linghuchong/Downloads/51/ForWin/Python/02_code/excel/tsz.xls"
...
class TSZ(unittest.TestCase):
    ...
    def Hometop3(self):
        sleep(8)
        #self.driver.find_element_by_id("com.mowin.tsz:id/splash").click() # 引导页
        sleep(8)
        ...
        # if self.isElement("com.mowin.tsz:id/thmub")==True:
        #     pass
        # else:
        #     print "e1"
        #
        ...
        #self.driver.tap([(500,22)],1000)
        self.driver.swipe(300, 100, 500, 100, 1000);

        sleep(122)

        self.driver.find_element_by_id("com.mowin.tsz:id/private_msg").click() # 私信
        self.driver.find_element_by_id("com.mowin.tsz:id/private_layout").click() # 令狐冲的红包群
        print self.driver.find_element_by_id("com.mowin.tsz:id/title").text

        print self.driver.find_element_by_id("com.mowin.tsz:id/no_data_layout").text
        self.driver.find_element_by_xpath("//android.widget.RelativeLayout/android.widget.ImageView[2]").click()

        self.driver.find_element_by_id("com.mowin.tsz:id/all_group_member").click()

        self.driver.find_element_by_id("com.mowin.tsz:id/search_edit").send_keys("123")

        self.driver.find_element_by_id("com.mowin.tsz:id/cancel").click()

        self.driver.find_element_by_id("com.mowin.tsz:id/back").click()  #back
