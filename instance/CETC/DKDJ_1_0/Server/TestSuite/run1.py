...
class Run1(unittest.TestCase):
    ...
    varExcel = os.path.abspath(r"../TestData/web20.xls")
    varExcelReportPath = os.path.abspath(r"../TestReport/dkdj_")
    varExcelReport = ""
    ...
    HTMLTestRunner.HTMLTestRunner(stream=fp, title='党建项目', description='测试报告').run(suite)
    fp.close()
