...
# varExcel = os.path.abspath(r"../TestData/Yunhuizhen_1_0.xls")  # run1, 批量跑
varExcel = os.path.abspath(r"../../TestData/Yunhuizhen_1_0.xls")  # 单独运行
...
class Login(unittest.TestCase):
    ...
    def test_L1createProject(self):
        ...
        Login_PO.open(3)
        Login_PO.inputID(u'user', sheetParam.cell_value(3, 1))
        Login_PO.inputID(u'pwd', sheetParam.cell_value(3, 2))
        Login_PO.xx()



        Login_PO.inputID(u'code', sheetParam.cell_value(3, 3))
        Login_PO.clickLINKTEXT(u'登录',2)
        sleep(1212)
