                ...
                for p in range(len(t0)):  #  共有len(t0)张表
                    ...
                    if n != 0:
                        ...
                        for i in range(0,len(list0)):
                            # cur.execute('select %s from %s where %s="%s" ' % (list0[i],varTable,list0[i],varValue))
                            # t3=cur.fetchall()
...
# getValueFromTBL('dangjian', '*','char', u'%13816109050%')
getValueFromTBL('yunhuizhen', '*','char', u'%admin123%')
