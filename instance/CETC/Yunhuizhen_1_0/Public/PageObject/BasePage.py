...
class BasePage(object):
    ...
    def select_byName(self, byname, content):
        # 下拉框，定位ByName，选择某一内容， text = value
        try :
            Select(self.driver.find_element_by_name(byname)).select_by_value(content)
        except:
            print u"页面中未找到'%s'选项" %(content)
    ...
    #     self.driver.save_screenshot(u'/Users/linghuchong/Downloads/51/1.png')
    #     sleep(3)
    #     # box=(startX, startY, endX, endY)
    #     i = Image.open(u'/Users/linghuchong/Downloads/51/1.png')
    #     newImage = i.crop(int(a),int(b),varWidth,varHeight)
    #     newImage.save(u'/Users/linghuchong/Downloads/51/1.png')
