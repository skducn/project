...
desired_caps['appPackage'] = PackageName   #''com.cetc.partybuilding'
desired_caps['appActivity'] = LaunchActivityName  #"com.cetc.partybuilding.activity.InitActivity"
...
class AppDangjian(unittest.TestCase):
   ...
   # #判断app元素是否存在,不存在则返回时间戳
    ...
    def loginMember(self):
        sleep(5)
        driver.find_element_by_id("com.cetc.partybuilding:id/et_phonenum_login").send_keys(u"13636371320")
        driver.find_element_by_id("com.cetc.partybuilding:id/et_psw_login").send_keys(u"123456")
        driver.find_element_by_id("com.cetc.partybuilding:id/btn_login").click()
        sleep(2)
        driver.find_element_by_id("com.cetc.partybuilding:id/learn_plan").click()
        sleep(2)
        print driver.find_element_by_id("com.cetc.partybuilding:id/title_tv").text

    def exitMember(self):
        driver.find_element_by_id("com.cetc.partybuilding:id/back_btn").click()
