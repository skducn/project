...
class cjl(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        # desired_caps['appPackage'] = 'com.mowin.scenesdeer'
        # desired_caps['appActivity'] = 'com.mowin.scenesdeer.SplashActivity'
        ...
        # iOS environment
# /Users/linghuchong/PycharmProjects/untitled/CETCPartyBuilding.ipa
        print "start"
        desired_caps = {}
        desired_caps['platformName'] = 'iOS'
        desired_caps['platformVersion'] = '9.1'
        desired_caps['deviceName'] = 'iPhone Simulator'
        # desired_caps['app'] = PATH('/Users/linghuchong/PycharmProjects/untitled/CETCPartyBuilding.ipa')
        desired_caps['Udid'] =  "405537558EE589296B8180E4D6312A1582FE9179"
        desired_caps['bundleId'] =  "com.cetc.partybuildingtest"
        self.driver = webdriver.Remote('http://localhost:4723/wd/hub', desired_caps)
        sleep(1212)
        ...
        # 场景鹿，场景进入
        sleep(4)
        self.driver.find_element_by_id(sheetMain.cell_value(1, 5) + ":id/nextView").click()
        print "场景鹿，生活的每一刻 都是一个场景，场景进入>"
        sleep(7)
