...
ReportHtmltime = "/Users/linghuchong/Downloads/51/ForWin/Python/03_Project/TSZ/report/tszTable" + varTimeYMDHSM + ".html" # TestReport文件
...
class tsz(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        # desired_caps['app'] = 'com.huiyindongliang.tsz'
        desired_caps['app'] = "/Users/linghuchong/Downloads/tsz.ipa"
        desired_caps['udid'] = '52B9E06914F7B8E76544C56D9D2E74BFAA25AE4F'
        desired_caps['platformName'] = 'iOS'
        desired_caps['deviceName'] = 'iPhone6P'
        desired_caps['platformVersion'] = '9.2.1'
        desired_caps['autoAcceptAlerts'] = 'true'
        desired_caps['CapabilityType.PLATFORM'] = 'MAC'
...
# self.driver.switch_to_default_content()
    ...
    def groupMy(self):
        ...
        sleep(3)
        self.driver.find_elements_by_id("com.mowin.tsz:id/content_layout")[0].click() # 点击我的群

        # self.driver.find_element_by_id("com.mowin.tsz:id/more_group").click() # 更多群




    def groupCommunication(self):
        pass
    def groupMore(self):
        pass
