...
for i in range(len(r_itf_ITF_TB_EHR_MAIN_INFO_icCardNo)):
    for j in range(len(suiji)):
        if suiji[j] == i :
            ...
            # convert(nvarchar(20), Name)
            # convert(nvarchar(20), ArchiveUnit)
            ...
            # Openpyxl_PO.clsRowData(2,"ITF_TB_EHR_MAIN_INFO")
            ...
            # print(l_dc_HrPersonBasicInfo_fieldName)
            ...
            # HrPersonBasicInfo 值
            # Openpyxl_PO.clsRowData(2,"HrPersonBasicInfo")
