...
print("\n表12 = 12.家庭医生维度签约居民中65岁及以上老年人电子健康档案工作指标 >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
...
print("\n表13 = 13.家庭医生维度签约居民中高血压患者电子健康档案工作指标 >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
Report_PO.colResult([["表13.签约居民中高血压患者管理人数占家庭医生签约总人数占比", "=", "签约居民中高血压患者有电子健康档案的人数", "/", "签约人数", "*100", 2],
...
print("\n表14 = 14.家庭医生维度签约居民中糖尿病患者电子健康档案工作指标 >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
Report_PO.colResult([["表14.签约居民中糖尿病患者管理人数占家庭医生签约总人数占比", "=", "签约居民中糖尿病患者有电子健康档案的人数", "/", "签约人数", "*100", 2],
...
print("\n表15 = 15.家庭医生维度签约居民中重点人群电子健康档案工作指标 >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
