...
class HTTP:
    ...
    def postLogin(self, interName, param):
        ...
        url = "http://192.168.0.16:18081/" + interName
        ...
        self.session.headers['token'] = "111111111111"
...
if __name__ == '__main__':
    http = HTTP()
    http.postLogin("/fsms/login", {'depCode': '05', 'systemId': '3A5A4B7E6757429BAE98A8BC010909AF', 'userName': '017', 'password': 'e10adc3949ba59abbe56e057f20f883e'})
