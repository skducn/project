...
newbk = copy(bk)
styleBlue = xlwt.easyxf('font: height 240 ,name Times New Roman, color-index blue')
styleRed = xlwt.easyxf('font: height 240 ,name Times New Roman, color-index red')
