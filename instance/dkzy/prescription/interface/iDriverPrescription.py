...
# 外部数据源
varExcel = os.path.dirname(os.path.abspath("__file__")) + u'../source/interface.xls'
print varExcel
var = os.path.abspath(os.path.join(os.path.dirname("__file__"), os.path.pardir)) + "/source/interface.xls"
print var
sleep(1212)
