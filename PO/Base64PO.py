...
"""
1.1，将base64转图片 base64ToImg()
1.2，图片转base64 img2base64()
"""
...
class Base64PO:
    ...
    def base64ToImg(self, dataURI, file='captcha'):
    ...
    def img2base64(self, file):

        """
        2,图片转base64
        :param file: 图片文件
        :return: data URI scheme
            eg:
            src="data:image/gif;base64,R0lGODlhMwAxAIAAAAAAAP///
                yH5BAAAAAAALAAAAAAzADEAAAK8jI+pBr0PowytzotTtbm/DTqQ6C3hGX
                ElcraA9jIr66ozVpM3nseUvYP1UEHF0FUUHkNJxhLZfEJNvol06tzwrgd
