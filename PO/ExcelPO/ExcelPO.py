...
if __name__ == "__main__":
    ...
    # # Excel_PO.createExcel("d:\\test1.xlsx")  # 覆盖式新建excel，生成一个工作表Sheet1
    # # Excel_PO.createExcel("d:\\test2.xlsx", "mySheet1")  # 覆盖式新建excel，生成一个工作表mySheet1
    # # Excel_PO.createExcel("d:\\test3.xlsx", "mySheet1", "mySheet2", "mySheet3")  # 覆盖式新建excel，生成三个工作表（mySheet1,mySheet2,mySheet3），默认定位在第一个mySheet1表。
    #
    # print("2.1，单个元素写操作（by openpyxl）".center(100, "-"))
    # Excel_PO.writeXlsx("d:\\test3.xlsx", "mySheet3", 5, 3, "测试一下")  # 对 mySheet3 的第5行第3列写入内容
    ...
    #
    # print("3.3，获取总行数".center(100, "-"))
    # print(Excel_PO.getAllRows("d:\\test3.xlsx"))  # 10  //默认定位第一张工作表，10行数据
    # print(Excel_PO.getAllRows("d:\\test3.xlsx", "mySheet1"))  # 10  //同上
    # print(Excel_PO.getAllRows("d:\\test3.xlsx", 1))  # 11  //定位第二张工作表的行数
    #
    # print("3.4，获取行列数".center(100, "-"))
    # print(Excel_PO.getRowCol("d:\\test3.xlsx"))  # [10, 4]  // 默认定位第一张工作表，10行4列
    # print(Excel_PO.getRowCol("d:\\test3.xlsx", "mySheet1"))  # [10, 4] // 同上
    # print(Excel_PO.getRowCol("d:\\test3.xlsx", 1))  # [11, 12]  // 定位第二张工作表的行列数
    #
    # print("3.5，获取行值".center(100, "-"))
